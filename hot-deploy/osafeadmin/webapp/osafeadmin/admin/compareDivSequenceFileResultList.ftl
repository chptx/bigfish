        ...
        <td class="actionColSmall">
          <#if compareDivResult.type?has_content>
            <#if compareDivResult.type == "2" && compareDivResult.key?has_content>
              ...
              <a href="<@ofbizUrl>addMissingDivSeqItem?addKey=${compareDivResult.key?if_exists}&amp;screenType=${compareDivResult.screen?if_exists}</@ofbizUrl>" onMouseover="javascript:showTooltip(event,'${addKeyTooltipText!""}');" onMouseout="hideTooltip()" class="createIcon"></a>
            </#if>
            <#if compareDivResult.type == "3" && compareDivResult.key?has_content && valuesMatch == "false">
              ...
              <a href="<@ofbizUrl>changeDivSeqItemValue?key=${compareDivResult.key?if_exists}&amp;screenType=${compareDivResult.screen?if_exists}&amp;newValue=${valueCompareToLabelFile}</@ofbizUrl>" onMouseover="javascript:showTooltip(event,'${addKeyTooltipText!""}');" onMouseout="hideTooltip()" class="syncIcon"></a>
            </#if>
          </#if>
        </td>
      </tr>
