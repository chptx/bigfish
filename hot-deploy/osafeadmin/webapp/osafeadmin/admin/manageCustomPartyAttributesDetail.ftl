    ...
    <table class="osafe" cellspacing="0">
       <thead>
         <tr class="heading">
           ...
           <th class="descCol">${uiLabelMap.SeqNoLabel}
           ...
           <th class="seqCol">${uiLabelMap.CaptionLabel}</th> 
           <th class="seqCol">${uiLabelMap.TypeLabel}</th>
           <th class="seqCol">${uiLabelMap.MandatoryLabel}</th>
         </tr>
       </thead>
       <tbody>
