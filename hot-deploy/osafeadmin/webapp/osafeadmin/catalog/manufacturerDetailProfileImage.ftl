  ...
  <div class="infoEntry">
    ...
    <div class="infoValue">
      <#if profileImageUrl?has_content && profileImageUrl != "">
        <img src="<@ofbizContentUrl>${profileImageUrl!}?${curDateTime!}</@ofbizContentUrl>" alt="${profileImageUrlStr!}" height="${globalContext.IMG_SIZE_PDP_REG_H!""}" width="${globalContext.IMG_SIZE_PDP_REG_W!""}" class="imageBorder"/>
      <#else>
