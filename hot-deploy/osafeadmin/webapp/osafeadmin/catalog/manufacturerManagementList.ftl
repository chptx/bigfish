        ...
        <#if resultList?exists && resultList?has_content>
            ...
            <#list resultList as partyRow>
                  ...
                  <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                    <td class="idCol <#if !partyRow_has_next>lastRow</#if> firstCol" ><a href="<@ofbizUrl>manufacturerDetail?manufacturerPartyId=${partyRow.partyId}</@ofbizUrl>">${partyRow.partyId}</a></td>
