                    	...
                    	<fo:table-body>                 
                          ...
                          <fo:table-cell>
                            ...
                            <fo:block text-align="start" font-size="10pt"  text-indent="5mm">
                                ${uiLabelMap.PhCaption}<#if formattedHomePhone?has_content>${formattedHomePhone!}</#if><#if formattedHomePhone?has_content && formattedCellPhone?has_content>,</#if> ${formattedCellPhone!}
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell>
