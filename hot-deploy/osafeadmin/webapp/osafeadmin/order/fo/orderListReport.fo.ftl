                    	...
                    	<#if checkoutShowSalesTaxMulti?exists && checkoutShowSalesTaxMulti?has_content && checkoutShowSalesTaxMulti>
							  ...
							  <#if distinctTaxAuthorityRateSeqIds?has_content>
							    <#list distinctTaxAuthorityRateSeqIds as taxAuthorityRateSeqId >
								  ...
								  <fo:table-row>
					                <fo:table-cell></fo:table-cell>
					                <fo:table-cell>
					                  <fo:block text-align="right">${uiLabelMap.SalesTaxLabel!}(${appliedTax.comments!} ${appliedTax.sourcePercentage!}%):</fo:block>
					                </fo:table-cell>
					                <fo:table-cell>
							...
							<#else>
						      <fo:table-row>
		                        <fo:table-cell></fo:table-cell>
		                        <fo:table-cell>
		                          <fo:block text-align="right">${uiLabelMap.SalesTaxLabel!}(${totalTaxPercent}%):</fo:block>
		                        </fo:table-cell>
		                        <fo:table-cell>
