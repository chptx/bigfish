...
<form method="post" name="productListForm" id="productListForm">
  <input type="hidden" name="plp_qty" id="plp_qty" value=""/>
  <input type="hidden" name="plp_add_product_id" id="add_product_id" value=""/>
  <input type="hidden" name="plp_add_category_id" id="add_category_id" value=""/> 
  <input type="hidden" name="plp_add_product_name" id="add_product_name" value=""/> 
