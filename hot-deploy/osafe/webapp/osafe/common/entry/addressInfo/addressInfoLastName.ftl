...
<div class="${request.getAttribute("attributeClass")!}">
    <!-- address last name -->
      ...
      <input type="text" maxlength="100" class="addressLastName" name="${fieldPurpose?if_exists}_LAST_NAME" id="js_${fieldPurpose?if_exists}_LAST_NAME" value="${requestParameters.get(fieldPurpose+"_LAST_NAME")!lastName!}"/>
